...
%---------------------------------------------------------
  \cventry
    ...
    {February 2024 – June 2024 } % Date(s)
    {
...
%---------------------------------------------------------
  \cventry
    ...
    {VMWare} % Organization
    {Remote (Colombia)} % Location
    {December 2020 - February 2023 } % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Build an maintain the CLI and some of its plugins for the VMware Tanzu Platform.}
        \item {Built and maintain automated CI/CD pipelines on GitHub and internal Concourse CI/CD Pipelines using Docker, GCP and gitops.}
...
%---------------------------------------------------------
  \cventry
    {Backend JVM Engineer} % Job title
...
%---------------------------------------------------------
  \cventry
    {Senior Java Software Engineer} % Job title
    {Globant} % Organization
    {Bogota, Colombia} % Location
    {October 2015 – April 2019} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
